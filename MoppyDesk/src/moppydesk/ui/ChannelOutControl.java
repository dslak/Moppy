...
public class ChannelOutControl extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        midiOutLabel.setForeground(new java.awt.Color(255, 204, 102));
        midiOutLabel.setText("MIDI Out:");
        midiOutLabel.setEnabled(false);

        enabledCB.setText(String.valueOf(settings.MIDIChannel));
        enabledCB.setBorder(null);
        enabledCB.setBorderPaintedFlat(true);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(4, 4, 4)
                .addComponent(comComboBox, 0, 132, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(midiOutLabel)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(midiOutComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
